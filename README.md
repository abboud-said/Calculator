...
**Live:** https://calculator-abboud.vercel.app
...
```bash
git clone https://github.com/abboud-said/Calculator.git
```
Open `index.html` in your browser. Start using the calculator!
...
- 🔗 GitHub: [abboud-said](https://github.com/abboud-said)
- 🔗 LinkedIn: [www.linkedin.com/in/abboud-said-aa682710b](https://www.linkedin.com/in/abboud-said-aa682710b)
